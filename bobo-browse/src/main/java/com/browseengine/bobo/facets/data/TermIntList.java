...
public class TermIntList extends TermNumberList<Integer> {
	...
	public boolean add(String o) {
		if (_innerList.isEmpty() && o != null) {
			withDummy = false; // the first value added is not null
		}
		int item = parse(o);
	...
	public int indexOf(Integer value) {
		if (withDummy) {
			...
			return Arrays.binarySearch(_elements, 1, _elements.length, value);
		} else {
			return Arrays.binarySearch(_elements, value);
		}
	}
