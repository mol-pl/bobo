...
public class BrowseHit implements Serializable {
	...
	public static class SerializableExplanation implements Serializable {
		...
		/**
		 * @return The value assigned to this explanation node.
		 */
		...
		/**
		 * @return A description of this explanation node.
		 */
		...
		/**
		 * @return The sub-nodes of this explanation node.
		 */
		...
		protected String toString(int depth) {
			...
			buffer.append(getValue()).append(" = ").append(getDescription());
			buffer.append("\n");
