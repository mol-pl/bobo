...
public class BrowseSelection implements Serializable {
	...
	public static enum ValueOperation {
		ValueOperationOr, ValueOperationAnd;
	}
	...
	public int getDepth() {
		try {
			return Integer.parseInt(_selectionProperties
					.getProperty(PathFacetHandler.SEL_PROP_NAME_DEPTH));
		} catch (Exception e) {
			return 0;
		}
	}
	...
	public String toString() {
		...
		buf.append("nots: ").append(notValues);
		buf.append("op: ").append(selectionOperation);
		buf.append("sel props: ").append(_selectionProperties);
		return buf.toString();
	}
